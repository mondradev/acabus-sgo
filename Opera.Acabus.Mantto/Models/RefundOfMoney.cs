...
namespace Opera.Acabus.Mantto.Models
{
    ...
    public sealed class RefundOfMoney : NotifyPropertyChanged
    {
        ...
        /// <summary>
        /// Crea una instancia de <see cref="RefundOfMoney"/> indicando su asociación a una <see cref="Models.Incidence"/>.
        /// </summary>
        /// <param name="incidence">
        /// Instancia de <see cref="Models.Incidence"/> a la que está asociada.
        /// </param>
