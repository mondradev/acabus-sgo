...
namespace ACABUS_Control_de_operacion.Acabus
{
    internal class AcabusData
    {
        ...
        internal const String SSH_PASSWORD_SERVER = "Op3r4#2o18";
        ...
        internal const string QUERY_FILE_ACCE_EST_TPR = "Queries\\Acce_Estaciones_TPR.sql";
        internal const string QUERY_FILE_ACCE_VEHI_TPR = "Queries\\Acce_Vehi_TPR.sql";
        internal const string QUERY_FILE_ACCE_VEHI_CRED_COST_TPR = "Queries\\Acce_Vehi_Cred_Cost_TPR.sql";
        internal const string QUERY_FILE_ACCE_VEHI_CRED_TPR = "Queries\\Acce_Vehi_Cred_TPR.sql";
